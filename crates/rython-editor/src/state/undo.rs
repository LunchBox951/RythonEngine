...
fn default_component_json(type_name: &str) -> Value {
    match type_name {
        "TransformComponent" => serde_json::to_value(TransformComponent::default()).unwrap(),
        "MeshComponent" => serde_json::to_value(MeshComponent::default()).unwrap(),
        "TagComponent" => serde_json::to_value(TagComponent::default()).unwrap(),
        "RigidBodyComponent" => serde_json::to_value(RigidBodyComponent::default()).unwrap(),
        "ColliderComponent" => serde_json::to_value(ColliderComponent::default()).unwrap(),
        "BillboardComponent" => serde_json::to_value(BillboardComponent::default()).unwrap(),
        _ => Value::Null,
    }
}
